...
class _SearchDestinationState extends State<SearchDestination> {
                        ...
                        children: <Widget>[
                          Row(
                            children: <Widget>[
                              Flexible(
                                child: AutoSizeText(
                                    (_placesList[index].mainText == null) ? '' : _placesList[index].mainText,
                                    maxLines: 3,
                          ...
                          Row(
                            children: <Widget>[
                              Flexible(
                                child: AutoSizeText(
                                    (_placesList[index].secondaryText == null) ? '' : _placesList[index].secondaryText,
                                    maxLines: 3,
                                    style: TextStyle(
  ...
  void findPlace(String placeName) async {
    if (placeName.length > 1) {
      ...
      String request =
          '$baseURL?input=$placeName&location=40.7128,74.1059&radius=1000&key=$mapKey&components=country:pk';
